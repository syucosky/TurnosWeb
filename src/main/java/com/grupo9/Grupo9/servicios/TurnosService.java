...
public class TurnosService {
    ...
    @Transactional
    public void crearTurnos(LocalDate fecha, LocalTime hora, String medico, String lugar, EspecialidadEntidad especialidad, PacienteEntidad paciente) throws MiExcepcion, Exception{
        try{
